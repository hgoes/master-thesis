...
Um nun zeigen zu können, dass das definierte GTL-System $(m,c,v)$ bisimular zum übersetzten Promela Modell $tr(m,c,v)$ ist, müssen folgende Anforderungen an die Semantik gestellt werden:
\begin{enumerate}
