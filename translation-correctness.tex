...
\[ \inference[IfDo-proc]{
  ...
  \xymatrix{ \left<\gamma(i).\sigma_e,\textrm{C\_}p_i\textrm{\_}p_i'\right>\ar@{|->}[r]^-{\llbracket \varphi(p_i')\rrbracket_C} & _{proc}
    \left<\gamma(i).\sigma_e,\textrm{A\_}p_i\textrm{\_}p_i'\right>}
  }
  }
  { \xymatrix{ \left<\gamma(i).\sigma_e,\textrm{st\_}p_i\right> \ar@{|->}[r]^-{\llbracket \varphi(p_i')\rrbracket_C} & _{proc}
      \left<\gamma(i).\sigma_e,\textrm{A\_}p_i\textrm{\_}p_i'\right>}
  }
\]