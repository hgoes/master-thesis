...
Zwar führen meist viele unterschiedliche Verschachtelungen zu den selben Zuständen, aber im schlimmsten Fall führt eine vollständig asynchrone Architektur zu einer gewaltigen Zustandsexplosion.
