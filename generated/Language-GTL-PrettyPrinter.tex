...
\haddockdecltt{::} & \haddockdecltt{(Show a, Ord a)} \\
                     \haddockdecltt{=>} & \haddockdecltt{Maybe (Map a (Map String TypeRep,}& \\
                                        & \haddockdecltt{Map String TypeRep, String, Double, Double))} & Can provide interfaces for the contained models if needed.\\
