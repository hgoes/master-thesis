...
\haddockdecltt{=} & \haddockdecltt{ModelDecl} & \\
 ...
 \\
                    , & \haddockdecltt{modelContract :: [Expr String Bool]} & A list of contracts that this model fulfills.
 \\
...
\haddockdecltt{=} & \haddockdecltt{VerifyDecl} & \\
                    \{ & \haddockdecltt{verifyFormulas :: [Expr (String, String) Bool]} & The formulas to be verified.
 \\
                    \} &
\end{tabulary}\par
...
\end{tabular}]\haddockbegindoc
\haddockbeginargs
\haddockdecltt{::} & \haddockdecltt{ExistsBinding} & A map of bound variables
 \\
                                                     \haddockdecltt{->} & \haddockdecltt{GExpr} & The expression to convert
 \\
                                                                                                  \haddockdecltt{->} & \haddockdecltt{Either String (Expr (Maybe String, String) Bool)} & \\
\end{tabulary}\par
...
\end{tabular}]\haddockbegindoc
Same as \haddockid{typeCheckBool} but returns an expression of type \haddockid{Int}.
\par
