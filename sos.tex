...
Gegeben ein Büchi-Automat $(Q,\Sigma,\delta,\mu,q_0,\emptyset)$ lässt sich ein äquivalenter nicht-deterministischer Mealy Automat $(Q,\Sigma',\Omega,\delta',q_0)$ erzeugen mit:
\[ \forall q,q'\in Q: (q\delta q'\land \mu(q') = p) \Leftrightarrow (\forall a\in l(p): \delta'(q,\mathit{inp}(a)) = (q',\mathit{outp}(a))) \]
