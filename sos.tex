...
Gegeben ein Büchi-Automat $(Q,\Sigma,\delta,\mu,q_0,\emptyset)$ lässt sich ein äquivalenter nicht-deterministischer Mealy Automat $(Q\cup\{\const{init}\},\Sigma',\Omega,\delta',\{\const{init}\})$ erzeugen mit:
\[
\begin{array}{c}
